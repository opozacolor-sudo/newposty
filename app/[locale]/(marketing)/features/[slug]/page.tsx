  ...
  return (
    <article className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 sm:py-16 lg:py-20">
      <header className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
        ...
        <img src={page.hero} alt="" className="aspect-[16/9] w-full rounded-3xl object-cover" />
      </header>
      ...
      <section className="mt-16 grid items-center gap-8 lg:grid-cols-2 lg:gap-14">
        <img src={page.detail} alt="" className="aspect-[4/3] w-full rounded-3xl object-cover" />
        <div>
      ...
      {rail ? (
        <section className="mt-16">
          <h2 className="text-[11px] font-medium uppercase tracking-[0.14em] text-neutral-400">
            {page.rail === "ads" ? t("ads") : t("channels")}
          </h2>
