...
export function chatPostSystemPrompt(input: {
  ...
  return [
    ...
    "You can see photos attached on THIS turn. Write captions from what you see. You cannot watch videos — for video, only use what the user said. Never invent a car or product that is not in the photo. Never use older photos from this chat unless they ask.",
